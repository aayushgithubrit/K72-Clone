  ...
  const projects = [
   {
    ...
    image2 : 'https://k72.ca/uploads/caseStudies/BEST/BEST_site_menu_Thumbnail-1280x960.jpg'},
  ...
  return (
    <div className='lg:p-4 p-2'>
      <div className=' pt-[35vh]'>
        <h2 className='font-[font2] uppercase lg:text-[11vw] text-7xl'>Projets</h2>
      </div>
      <div className='-lg:mt-9 lol' > 
        {projects.map (function(elem, idx) {
            return <div key={idx} className=' hero flex lg:flex-row flex-col lg:gap-4 gap-2 w-full lg:h-[500px] mb-4 '>
